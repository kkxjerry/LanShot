...
APP = ROOT / "LanShotAudioCapture.app"
DEFAULT_OUTPUT = Path.home() / "Library/Application Support/LanShotAudio"
...
def main() -> int:
    parser = argparse.ArgumentParser(description="双路面试音频采集和语音识别")
